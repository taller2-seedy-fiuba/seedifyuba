...
const SELECT = 'SELECT P.id, P.hash, P.owner_address, P.state, P.current_stage, P.total_amount_needed, P.missing_amount ' + PROJECTS_TABLE;
...
const updateById = (updates) => {
  return new Promise((resolve, reject) => {
    queries.executeQueryWithParams(UPDATE_BY_ID, [
      updates.projectId,
      updates.state,
